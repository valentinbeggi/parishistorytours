export const fr = {
  ...
  nav: {
    ...
    reviews: "Avis",
    bookTour: "Réserver votre Visite",
    gallery: "Galerie"
  },
  ...
  common: {
    hours: "heures",
    walking: "à pied",
    historicStops: "arrêts historiques",
    duration: "2 heures",
  ...
  tours: {
    ...
    themes: {
      ...
      resistance: {
        title: "La Résistance",
        description: "Apprenez comment certains résistants français ont opéré sous le nez des occupants nazis, utilisant ingéniosité et courage pour protéger leur ville et sa culture."
      },
      liberation: {
        title: "Libération",
    ...
    rightBank: {
      ...
      stops: {
        stop1: {
          title: "Pont Alexandre III - Introduction",
          description: "Notre premier arrêt consiste à mettre tout le monde au même niveau — tout en s'amusant un peu. Nous planterons le décor du Paris de la Seconde Guerre mondiale, en vous présentant les événements et personnages clés à retenir. Il y a un quiz au programme, alors écoutez bien…"
        },
        stop2: {
          title: "Ministère des Affaires étrangères - La Chute",
          description: "Ici, nous revenons sur une réunion décisive tenue immédiatement après l'assaut allemand en mai 1940. Vous découvrirez les décisions importantes prises ce jour-là par le gouvernement sur l'avenir de la capitale française."
        },
        stop3: {
          title: "Place de la Concorde - La Résistance",
          description: "En passant à la période de l'Occupation, nous nous concentrerons sur l'histoire d'une résistante française nommée Rose Valland. Pendant 4 années consécutives, elle a risqué sa vie chaque jour pour suivre toutes les œuvres d'art saisies par les nazis à Paris et envoyées en Allemagne..."
        },
        stop4: {
          title: "Place Vendôme - Libération",
          description: "Des combats dans les rues, l'incertitude dans le commandement, et une légende littéraire — Ernest Hemingway — qui a juré de libérer un site parisien bien précis. A-t-il réussi ? Nous cultivons le suspense jusqu'au final symbolique."
        }
      }
    },
    leftBank: {
      ...
      quoteAuthor: "Charles de Gaulle, 25 août 1944",
      summary: "Cette visite de la Rive Gauche explore le Paris de la Seconde Guerre mondiale avec des histoires de la Chute, de la Résistance et de la Libération, vous guidant à travers quatre arrêts historiques.",
      didYouKnow: {
        title: "Le saviez-vous ? Faits historiques sur Paris pendant la Seconde Guerre mondiale",
        facts: [
      ...
      stops: {
        stop1: {
          title: "Boulevard Saint-Michel - Introduction",
          description: "Commencez votre voyage sur ce boulevard emblématique avec une présentation de la visite et un quiz d'histoire pour mettre tout le monde au même niveau ! Découvrez à quoi ressemblait Paris à la veille de l'invasion allemande et voyez les premiers signes de la guerre qui subsistent encore dans la ville."
        },
        stop2: {
          title: "Palais du Luxembourg - La Chute",
          description: "Traversez les jardins de ce magnifique palais et découvrez comment Paris est tombé aux mains de l'armée allemande en seulement 35 jours de combat. Apprenez comment ces 35 jours cruciaux ont changé la ville à jamais et comment les nazis ont transformé ce symbole de la culture française en centre de commandement de leur armée de l'air."
        },
        stop3: {
          title: "La Sorbonne - La Résistance",
          description: "Près de cette université historique, découvrez l'histoire d'Agnès Humbert, une courageuse résistante française qui faisait partie du premier réseau de résistance organisé à Paris, appelé Musée de l'Homme. Apprenez comment ces individus courageux ont tout risqué pour lutter contre l'occupation."
        },
        stop4: {
          title: "Notre-Dame de Paris - Libération",
          description: "Concluez notre visite devant cette cathédrale emblématique, témoin de la libération de Paris en août 1944. Découvrez les combats qui ont eu lieu dans Paris il y a 81 ans. Tenez-vous là où le Général de Gaulle a proclamé la liberté de la capitale et découvrez à quel point Paris a failli être gravement endommagé."
        }
      }
    },
    generalHistory: {
  ...
  reviews: {
    title: "Avis",
    subtitle: "Ce que disent les visiteurs de nos visites",
    seeMore: "Voir plus d'avis sur Google Maps",
    findUs: "Nous trouver sur Google Maps",
    noReviews: "Pas d'avis pour le moment",
    unavailable: "Les avis ne sont pas disponibles pour le moment",
  ...
  booking: {
    ...
    contactForm: "Contactez-moi directement pour discuter de vos préférences et disponibilités",
    email: "Email",
    ...
    privateTourDesc: "Planifiez une visite privée pour votre groupe uniquement",
    contact: {
      name: "Nom *",
    ...
    calendar: {
      blueDates: "Les dates en bleu ont des sessions disponibles pour",
      availableSessions: "Sessions disponibles pour",
      for: "pour",
      spotsAvailable: "places disponibles",
      loading: "Chargement...",
      perPerson: "par personne",
      total: "Total :",
      noSessions: "Pas de sessions disponibles pour",
      onThisDate: "à cette date.",
      selectDate: "Sélectionnez une date dans le calendrier pour voir les sessions disponibles.",
      sessionSelected: "Session sélectionnée :",
      at: "à"
    },
    private: {
      ...
      note: "Note :",
      noteText: "Ceci est votre date et heure préférées. Nous confirmerons la disponibilité et vous recontacterons dans les 12 heures."
    },
    summary: {
      tour: "Visite :",
      participants: "Participants :",
      ...
      makeNewBooking: "Nouvelle réservation",
      privateConfirmMessage: "Merci pour votre demande de visite privée ! Nous vous avons envoyé un email de confirmation et nous vous contacterons dans les 24 heures pour confirmer la disponibilité et les détails de paiement.",
      yourRequestDetails: "Détails de votre demande",
      errorPayment: "Échec du traitement du paiement. Veuillez réessayer.",
      errorCheckout: "Échec de la création de la session de paiement.",
      errorNoRedirect: "Aucune URL de redirection fournie.",
      errorGeneral: "Une erreur est survenue lors du traitement de votre demande. Veuillez réessayer ou nous contacter directement."
    },
    progress: {
      tour: "Visite",
      participants: "Participants",
  ...
  keyFigures: {
    ...
    building: {
      ...
      subtitle: "La recherche approfondie et la préparation derrière chaque visite",
      books: {
        title: "20+ Livres",
        description: "Recherche approfondie à travers des textes historiques, mémoires et sources académiques pour assurer l'exactitude et la profondeur de chaque histoire racontée."
      },
      months: {
        title: "6 Mois",
        description: "Recherche dédiée, planification d'itinéraire et création d'histoires pour créer une expérience historique immersive dans les rues de Paris."
      }
    },
    delivering: {
      title: "Réaliser la Visite",
      subtitle: "L'impact et la portée de Paris History Tours",
  ...
  faq: {
    ...
    items: [
      {
        question: "Quelle est la durée de la visite guidée sur la Seconde Guerre mondiale à Paris ?",
        answer: "Chaque visite dure environ 2 heures et couvre environ 2,5 km avec 4 arrêts historiques. Le rythme est confortable pour tous les niveaux de forme physique."
      },
      {
        question: "Les visites sont-elles disponibles en français et en anglais ?",
        answer: "Oui, toutes les visites sont disponibles en français et en anglais. Choisissez votre langue préférée lors de la réservation."
      },
      {
        question: "Quelle est la différence entre les visites Rive Gauche et Rive Droite ?",
        answer: "Les deux visites couvrent trois thèmes : la Chute de Paris, la Résistance et la Libération. La visite Rive Gauche passe par le Boulevard Saint-Michel, les Jardins du Luxembourg, la Sorbonne et Notre-Dame. La visite Rive Droite couvre le Pont Alexandre III, la Place de la Concorde et la Place Vendôme. Chaque visite raconte des histoires uniques liées à ses lieux."
      },
      {
        question: "Puis-je réserver une visite privée ?",
        answer: "Oui, nous proposons des visites de groupe régulières (jusqu'à 10 personnes) et des visites privées pour votre groupe uniquement. Les visites privées offrent plus de flexibilité sur les dates et horaires."
      },
      {
        question: "La visite est-elle adaptée aux enfants ?",
        answer: "La visite est conçue pour les adultes et les adolescents intéressés par l'histoire. Le contenu couvre des événements de guerre et est présenté de manière éducative et respectueuse."
      },
      {
  ...
  email: {
    client: {
      subjectConfirmation: "Confirmation de réservation - Paris History Tours",
      subjectRequest: "Demande de réservation - Paris History Tours",
      greeting: "Bonjour",
      thankYouPaid: "Merci pour votre réservation et votre paiement ! Voici les détails :",
      thankYouRequest: "Merci pour votre demande de réservation ! Voici les détails :",
      tour: "Visite :",
      participants: "Participants :",
      type: "Type :",
      date: "Date :",
  ...
  quiet: {
    ...
    home: {
      ...
      about: {
        ...
        p1: "Parisien d'adoption — six ans dans la ville, toujours amoureux. Je passe l'essentiel de mes journées à arpenter ses rues, et mes soirées à les relire. Pour moi, l'histoire se fait à pied, avec les bâtiments comme témoins.",
        p2: "Mes visites sont en petit groupe (dix personnes maximum), sans précipitation. Je préfère bien raconter deux histoires que d'en bâcler vingt. La plupart durent deux heures ; les groupes privés choisissent le parcours qui leur convient.",
